package datepicker.defaults.view;
    ...
    private void buildViews(Context context) {
        ...
        switch (type) {
            case TYPE_DATE_TIME:
                ...
                dayPickerView = null;
                datePickerView = new PickerView(context, PickerView.LEFT_ROUND_PICKER);
                hourPickerView = null;
                minutePickerView = null;
                timePickerView = new PickerView(context, PickerView.RIGHT_ROUND_PICKER);
                break;
            case TYPE_DATE_HOUR_MINUTE:
                ...
                dayPickerView = null;
                datePickerView = new PickerView(context, PickerView.LEFT_ROUND_PICKER);
                hourPickerView = new PickerView(context, PickerView.EDGED_PICKER);
                minutePickerView = new PickerView(context, PickerView.RIGHT_ROUND_PICKER);
                timePickerView = null;
                break;
            case TYPE_YEAR_MONTH_DAY_HOUR_MINUTE:
                yearPickerView = new PickerView(context, PickerView.LEFT_ROUND_PICKER);
                monthPickerView = new PickerView(context, PickerView.EDGED_PICKER);
                dayPickerView = new PickerView(context, PickerView.EDGED_PICKER);
                datePickerView = null;
                hourPickerView = new PickerView(context, PickerView.EDGED_PICKER);
                minutePickerView = new PickerView(context, PickerView.RIGHT_ROUND_PICKER);
                timePickerView = null;
            ...
            case TYPE_YEAR_MONTH_DAY:
                yearPickerView = new PickerView(context, PickerView.LEFT_ROUND_PICKER);
                monthPickerView = new PickerView(context, PickerView.EDGED_PICKER);
                dayPickerView = new PickerView(context, PickerView.RIGHT_ROUND_PICKER);
                datePickerView = null;
                hourPickerView = null;
                minutePickerView = null;
                timePickerView = null;
        ...
        public String getText() {
            ...
            switch (field) {
                ...
                case FIELD_DAY:
                    ...
                    break;
                case FIELD_HOUR:
                    text = String.format(Locale.getDefault(), "%02d시", value);
                    break;
                case FIELD_MINUTE:
                    text = String.format(Locale.getDefault(), "%02d분", value);
                    break;
            }
            return text;
        }
