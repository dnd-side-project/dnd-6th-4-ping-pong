package com.dnd.sixth.lmsservice.presentation.home.manage.student

import android.view.MenuItem
import android.view.View
import com.dnd.sixth.lmsservice.R
import com.dnd.sixth.lmsservice.databinding.ActivityStudentBinding
...
class StudentActivity : BaseActivity<ActivityStudentBinding, StudentViewModel>(),
    ...
    private fun initView() {
        with(binding) {
            ...
            viewPagerAdapter = ClassInfoViewPagerAdapter(this@StudentActivity)
