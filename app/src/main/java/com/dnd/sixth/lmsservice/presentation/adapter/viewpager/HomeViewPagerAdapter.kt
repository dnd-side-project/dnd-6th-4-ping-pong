...
import com.dnd.sixth.lmsservice.presentation.main.studentmanage.StudentManageFragment

class HomeViewPagerAdapter(activity: FragmentActivity) : FragmentStateAdapter(activity) {

    // ViewPager2에 연결할 Fragment 생성
    private val fragmentList = listOf<Fragment>(ClassManageFragment(), StudentManageFragment())
