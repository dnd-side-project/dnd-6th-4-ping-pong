...
import com.dnd.sixth.lmsservice.databinding.FragmentChangeDoneDialogBinding
import com.dnd.sixth.lmsservice.presentation.home.HomeViewModel
import org.koin.androidx.viewmodel.ext.android.sharedViewModel


class ChangeDoneDialogFragment : DialogFragment(), View.OnClickListener {

    private lateinit var binding: FragmentChangeDoneDialogBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentChangeDoneDialogBinding.inflate(inflater, container, false) // 데이터 바인딩 객체 생성
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            goHomeBtn.setOnClickListener(this@ChangeDoneDialogFragment)
        }
    }
